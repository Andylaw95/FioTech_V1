...
export function DeviceHistoryChart({ deviceId, deviceType, devEui, focusMetric }: DeviceHistoryChartProps) {
  ...
  return (
    <div>
      {/* Clickable metric cards — show latest value + act as selector */}
