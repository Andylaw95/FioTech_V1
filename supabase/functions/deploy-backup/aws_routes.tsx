...
export function registerAWSRoutes(
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  // POST /aws/sync-devices — Sync AWS IoT Things → FioTec Devices
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    try {
      ...
      return c.json({
        ...
        summary: {
          ...
          updated,
          skipped,
          totalFioTecDevices: existingDevices.length,
        },
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  // POST /aws/push-telemetry — Push FioTec sensor data to AWS IoT Core
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  app.post(`${PREFIX}/aws/push-telemetry`, async (c: any) => {
    ...
    const topic = sanitizeString(body.topic || `fiotec/devices/${deviceName}/telemetry`, 512);
  ...
  console.log("[FioTec AWS] All AWS route handlers registered.");
}

// ── Type Mapping Helper ──────────────────────────────────

function mapAWSTypeToFioTecType(awsType: string): string {
